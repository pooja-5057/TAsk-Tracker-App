...
//       <main className="flex-1 p-5 bg-gray-900 overflow-y-auto relative">
//         {children}
//       </main>
//     </div>
//   );
...
const DashboardLayout = ({ currentUser, onSignOut, activeTab, setActiveTab, onManageAccountClick, children }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-screen bg-gray-800 rounded-none shadow-none overflow-hidden">
      <aside className="w-full lg:w-64 bg-gray-800 p-6 flex flex-col justify-between border-r border-gray-700">
        <div>
          <div
            className="flex items-center space-x-3 mb-8 cursor-pointer relative"
      ...
      <main className="flex-1 p-5 bg-gray-900 overflow-y-auto">
        {children}
      </main>
    </div>
  );
